...
namespace Services
{
    public class PersonsService : IPersonsService
    {
        ...
        public async Task<MemoryStream> GetPersonCSV()
        {
            ...
            CsvWriter csvWriter = new CsvWriter(streamWriter, csvConfiguration/*, true*/); //true - to start from begining after writing files (to keep stream open)
            ...
            List<PersonResponse> persons =  _db.Persons
                .Include("Country")
                .Select(item => item.ToPersonResponse()).ToList();
            ...
            memoryStream.Position = 0; //move cursor at begining of stream, to read memorystream from begining
            return memoryStream;
        }
